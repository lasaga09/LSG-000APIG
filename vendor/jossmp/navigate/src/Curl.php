...
class Curl
{
	...
	public function buildPostData($data)
	{
		...
		if (
			...
			$data = \jossmp\navigate\Encoder::encodeJson($data);
	...
	{
		$this->jsonDecoder = '\jossmp\navigate\Decoder::decodeJson';
	...
	{
		$this->xmlDecoder = '\jossmp\navigate\Decoder::decodeXml';
	...
	{
		$user_agent = 'Curl-PHP/' . self::VERSION . ' (+https://github.com/jossmp/)';
