...
public function convertirMonto($numero,$_moneda){
switch($_moneda)
{
case 1:
$_nommoneda='COLONES';
...
/*validar si viene con decimales*/
$numero=floatval($numero);
$isFloat=strpos($numero,'.');
if($isFloat){
...
/*validar si tiene solo el primer*/
if($tempnum[1] <= 9 && $tempnum[1] != '00'){
$tempnum[1]=$tempnum[1].'0';
}
